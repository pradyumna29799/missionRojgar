...
__all__ = [
    'SPVPRIORITY', 'SGDSActiveWithAutoPause', 'SPCS_DISABLED',
    'SAFT12kHz16BitMono', 'SpeechCategoryRecognizers', 'SVP_17',
    'STCLocalServer', 'DISPID_SVESentenceBoundary',
    'SPEI_SR_RETAINEDAUDIO', 'SVP_0', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'SREPrivate', 'DISPID_SLPSymbolic', 'SGSEnabled',
    'SVEStartInputStream', 'DISPID_SpeechDataKey',
    'DISPID_SPPFirstElement', 'SpeechRecoProfileProperties',
    'SPFM_OPEN_READWRITE', 'DISPID_SOTId',
    'DISPID_SpeechCustomStream', 'SREAdaptation', 'SVEPrivate',
    'SAFTExtendedAudioFormat', 'DISPID_SVEWord', 'SRADynamic',
    'SPEI_VISEME', 'SPEI_START_SR_STREAM', 'SpeechStreamFileMode',
    'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SDKSetStringValue', 'DISPID_SWFESamplesPerSec',
    'DISPID_SRDisplayUI', 'DISPID_SVEventInterests',
    'ISpPhoneticAlphabetSelection', 'SpeechFormatType',
    'SECFIgnoreWidth', 'DISPID_SpeechRecoContext', 'SPEI_MIN_TTS',
    'DISPID_SPAs_NewEnum', 'SP_VISEME_3', 'SPEI_UNDEFINED',
    'SAFTGSM610_8kHzMono', 'SAFT48kHz16BitStereo', 'SPAS_STOP',
    'ISpeechGrammarRules', 'SPRECORESULTTIMES', 'SAFT24kHz16BitMono',
    'IEnumString', 'DISPID_SPCLangId', 'ISpeechRecognizerStatus',
    'ISpRecognizer2', 'DISPID_SpeechGrammarRules',
    'ISequentialStream', 'DISPID_SGRSAddSpecialTransition',
    'ISpeechMemoryStream', 'SVF_Emphasis', 'SVF_None',
    'SSSPTRelativeToCurrentPosition', 'eLEXTYPE_PRIVATE2',
    'SPPHRASEELEMENT', 'DISPIDSPTSI_SelectionOffset',
    'DISPID_SRCEPhraseStart', 'eLEXTYPE_RESERVED6',
    'SDA_One_Trailing_Space', 'DISPID_SRRAlternates',
    'SpeechPropertyHighConfidenceThreshold', 'SITooFast',
    'DISPID_SRIsUISupported', 'DISPID_SGRSTsCount',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'SAFTCCITT_ALaw_8kHzMono', 'SAFTADPCM_11kHzMono',
    'eLEXTYPE_PRIVATE18', 'DISPID_SVWaitUntilDone', 'SP_VISEME_18',
    'DISPID_SLWs_NewEnum', 'DISPID_SDKEnumKeys', 'eLEXTYPE_PRIVATE17',
    'DISPID_SRRTimes', 'SP_VISEME_14', 'SPEI_SR_BOOKMARK',
    'eLEXTYPE_PRIVATE5', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'DISPID_SPPsCount', 'DISPID_SPIEnginePrivateData',
    'ISpeechPhraseInfoBuilder', 'SPPS_Verb',
    'SAFTCCITT_ALaw_11kHzMono', 'DISPID_SAFType',
    'DISPID_SABIBufferSize', 'DISPID_SPAsCount',
    'DISPID_SPEAudioSizeTime', 'DISPID_SVGetVoices',
    'DISPID_SLGetPronunciations', 'SpeechTokenKeyAttributes',
    'DISPID_SGRsDynamic', 'DISPID_SPRDisplayAttributes',
    'DISPID_SRGCmdSetRuleState', 'SPDKL_CurrentUser',
    'DISPID_SVEStreamStart', 'SVP_1', 'SpeechCategoryAudioIn',
    'SpeechAudioState', 'DISPIDSPTSI', 'DISPID_SVEStreamEnd',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'DISPID_SRCVoice', 'SPAO_NONE',
    'DISPID_SLWPronunciations', 'SPAO_RETAIN_AUDIO', 'SRTAutopause',
    'SVP_9', 'ISpPhraseAlt', 'SPEI_SR_AUDIO_LEVEL',
    'DISPID_SpeechPhraseElements', 'SREFalseRecognition',
    'ISpeechPhraseRule', 'SPVPRI_ALERT', 'DISPID_SPRuleChildren',
    'eLEXTYPE_PRIVATE13', 'SPWORDPRONUNCIATIONLIST', 'SRERequestUI',
    'SAFT24kHz8BitStereo', 'SpeechMicTraining',
    'SpeechCategoryVoices', 'DISPID_SRCCreateResultFromMemory',
    'SAFTCCITT_uLaw_44kHzMono', 'SPGS_ENABLED', 'SPSVerb',
    'DISPID_SAFGetWaveFormatEx', 'SP_VISEME_0', 'SVP_11',
    'DISPID_SRCESoundEnd', 'ISpRecoCategory', 'SP_VISEME_6',
    'DISPID_SRCBookmark', 'SPPS_SuppressWord',
    'SpeechSpecialTransitionType', 'DISPID_SRRTTickCount',
    'DISPID_SPPChildren', 'ISpObjectWithToken',
    'DISPID_SPEActualConfidence', 'DISPID_SPRuleId',
    'ISpeechObjectToken', 'SVPAlert', 'DISPID_SVAlertBoundary',
    'DISPID_SpeechLexiconProns', 'SPSERIALIZEDPHRASE',
    'DISPID_SRGetFormat', 'DISPID_SpeechObjectTokens', 'SAFTDefault',
    'eLEXTYPE_PRIVATE19', 'ISpeechLexiconPronunciation',
    'ISpeechPhraseReplacement', 'DISPID_SPERequiredConfidence',
    'SP_VISEME_15', 'DISPID_SRCEEnginePrivate',
    'SAFTCCITT_ALaw_44kHzStereo', 'DISPID_SVSLastResult',
    'SpeechLoadOption', 'DISPID_SLGetGenerationChange',
    'eLEXTYPE_PRIVATE20', 'SPSHORTCUTPAIRLIST', 'SPAUDIOSTATE',
    'SpMemoryStream', 'SPXMLRESULTOPTIONS', 'SDKLCurrentUser',
    'SPEI_RESERVED2', 'DISPID_SPERetainedSizeBytes',
    'SPCT_SUB_DICTATION', 'SpeechVisemeFeature',
    'SpeechWordPronounceable', 'SPBO_AHEAD', 'SASPause',
    'DISPID_SOTGetStorageFileName', 'SP_VISEME_1',
    'DISPID_SABIMinNotification', 'DISPID_SPRuleConfidence',
    '__MIDL_IWinTypes_0009', 'ISpeechRecoResult2', 'SRAImport',
    'DISPID_SRGDictationLoad', 'DISPID_SRCPause', 'DISPID_SVVoice',
    'ISpRecoResult', 'SPEI_SOUND_END', 'SAFTCCITT_uLaw_44kHzStereo',
    'ISpRecoGrammar', 'SPRST_INACTIVE', 'DISPID_SRGId',
    'DISPID_SLGenerationId', 'SPEI_PROPERTY_STRING_CHANGE',
    'DISPID_SPRFirstElement', 'DISPID_SLPsItem',
    'DISPID_SPANumberOfElementsInResult', 'DISPID_SRCEStartStream',
    'SREBookmark', 'DISPID_SREmulateRecognition', 'SGLexical',
    'ISpAudio', 'DISPID_SVSInputWordPosition', 'SPCONTEXTSTATE',
    'SAFTCCITT_uLaw_8kHzMono', 'ISpMMSysAudio', 'SRARoot',
    'ISpeechWaveFormatEx', 'SVP_21', 'DISPID_SRGetPropertyNumber',
    'ISpeechGrammarRuleStateTransitions', 'DISPID_SpeechAudio',
    'SPEI_RESERVED3', 'ISpPhrase', 'SPINTERFERENCE_NONE',
    'DISPID_SPRules_NewEnum', 'SDTReplacement',
    'DISPID_SRCRecognizer', 'SPSHT_EMAIL', 'DISPID_SFSClose',
    'SpeechAudioVolume', 'DISPID_SRIsShared', 'SpeechAllElements',
    'SAFTADPCM_44kHzMono', 'DISPID_SOTCGetDataKey',
    'DISPID_SPIElements', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'DISPID_SPPValue', 'DISPID_SOTGetDescription',
    'SAFTADPCM_8kHzMono', 'SpInprocRecognizer',
    'ISpeechPhraseAlternates', 'DISPID_SOTsCount',
    'DISPID_SOTCategory', 'SpeechVoiceEvents',
    'eLEXTYPE_LETTERTOSOUND', 'SPEI_SOUND_START',
    'DISPID_SVSLastStreamNumberQueued', 'SAFTADPCM_8kHzStereo',
    'SpeechVoicePriority', 'SAFT12kHz8BitMono', 'SpCompressedLexicon',
    'SpeechPropertyResponseSpeed', 'DISPID_SRGSetWordSequenceData',
    'DISPID_SOTsItem', 'ISpeechRecoResultDispatch',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SVP_20',
    'SPPS_RESERVED4', 'DISPID_SpeechLexicon',
    'DISPID_SRGDictationSetState', 'SPAR_Unknown', 'SPVPRI_NORMAL',
    'SDA_Two_Trailing_Spaces', 'SpeechDictationTopicSpelling',
    'DISPID_SRRGetXMLErrorInfo', 'ISpeechGrammarRuleState',
    'DISPID_SpeechAudioBufferInfo', 'SpMMAudioOut', 'SPXRO_SML',
    'SAFT32kHz16BitStereo', 'DISPID_SRCEBookmark', 'SPRECOSTATE',
    'DISPID_SRCRetainedAudioFormat', 'SAFT16kHz8BitStereo',
    'SAFT44kHz16BitStereo', 'DISPID_SRRGetXMLResult',
    'DISPID_SPRuleEngineConfidence', 'DISPID_SOTCDefault',
    'SPWT_LEXICAL', 'eLEXTYPE_PRIVATE3', 'STCRemoteServer',
    'SpeechCategoryAppLexicons', 'ISpeechLexiconPronunciations',
    'DISPID_SWFEExtraData', 'SVP_12',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SDTAlternates',
    'SPEI_SR_PRIVATE', 'SPSMF_SAPI_PROPERTIES', 'SPEI_ADAPTATION',
    'SAFT12kHz8BitStereo', 'eLEXTYPE_APP', 'DISPIDSPTSI_ActiveLength',
    'SPPS_RESERVED1', 'ISpRecoContext', 'eLEXTYPE_USER_SHORTCUT',
    'SpeechPartOfSpeech', 'SAFT12kHz16BitStereo',
    'DISPID_SDKGetlongValue', 'DISPID_SWFEBitsPerSample',
    'DISPID_SVSInputWordLength', 'SASStop', 'SAFT32kHz16BitMono',
    'DISPID_SpeechPhoneConverter', 'SDKLLocalMachine',
    'DISPID_SPPEngineConfidence', 'SRSEIsSpeaking',
    'DISPID_SpeechObjectToken', 'DISPID_SGRAttributes',
    'SPDKL_DefaultLocation', 'SSFMOpenForRead',
    'SAFTCCITT_uLaw_22kHzMono', 'SAFT44kHz16BitMono', 'SRATopLevel',
    'SPINTERFERENCE_TOOFAST', 'SAFT48kHz16BitMono', 'SPCT_COMMAND',
    'SPSERIALIZEDRESULT', 'SWPUnknownWordPronounceable', 'SASRun',
    'SpeechGrammarTagUnlimitedDictation',
    'SpeechVoiceSkipTypeSentence', 'SAFTCCITT_uLaw_8kHzStereo',
    'ISpeechGrammarRuleStateTransition', 'SGDSActiveUserDelimited',
    'DISPID_SpeechRecoResult', 'DISPID_SVDisplayUI', 'SPPS_RESERVED2',
    'SP_VISEME_21', 'SpObjectTokenCategory', 'DISPID_SRCState',
    'SpeechPropertyAdaptationOn', 'DISPID_SVSPhonemeId',
    'SDKLDefaultLocation', 'SPINTERFERENCE', 'SP_VISEME_20',
    'SINoise', 'DISPID_SGRSTRule', 'SPLOADOPTIONS',
    'DISPID_SRRTLength', 'SpNullPhoneConverter',
    'DISPID_SRCEventInterests', '_ISpeechRecoContextEvents',
    'DISPID_SVGetProfiles', 'SAFTADPCM_22kHzMono',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SOTIsUISupported', 'DISPID_SpeechBaseStream',
    'DISPID_SVSkip', 'SVSFlagsAsync', 'DISPID_SRStatus',
    'IInternetSecurityManager', 'SPADAPTATIONRELEVANCE',
    'SPPHRASEPROPERTY', 'DISPID_SPPParent', 'ISpSerializeState',
    'SPWORDPRONUNCIATION', 'DISPID_SVEPhoneme', 'SPRECOGNIZERSTATUS',
    'SpStreamFormatConverter', 'SVP_2',
    'DISPID_SpeechRecognizerStatus', 'DISPID_SLPPhoneIds',
    'DISPID_SPAPhraseInfo', 'SSSPTRelativeToStart', 'tagSTATSTG',
    'DISPID_SVStatus', 'SPLEXICONTYPE', 'SVEViseme',
    'DISPID_SCSBaseStream', 'SPSLMA', 'eWORDTYPE_ADDED',
    'SSTTWildcard', 'SLODynamic', 'eLEXTYPE_USER',
    'SPEI_INTERFERENCE', 'SAFTText', 'SVSFPurgeBeforeSpeak',
    'DISPID_SpeechPhraseReplacement', 'DISPID_SVPriority',
    'SPEI_VOICE_CHANGE', 'SBONone',
    'DISPID_SPPBRestorePhraseFromMemory', 'SpSharedRecognizer',
    'SPAUDIOSTATUS', 'SINoSignal', 'SAFT11kHz16BitStereo',
    'SPEI_PHONEME', 'SECFIgnoreCase', 'SPPHRASE', 'SPPHRASERULE',
    'DISPID_SPPId', 'ISpeechXMLRecoResult', 'SVPOver',
    'SPEI_TTS_PRIVATE', 'DISPID_SRCCreateGrammar', 'SpMMAudioIn',
    'DISPID_SPEDisplayText', 'SpMMAudioEnum', 'SpSharedRecoContext',
    'eLEXTYPE_PRIVATE11', 'ISpVoice', 'SPGS_DISABLED',
    'DISPID_SRCEEndStream', 'DISPID_SPEsCount', 'SVSFPersistXML',
    'eLEXTYPE_PRIVATE12', 'SPSTREAMFORMATTYPE',
    'DISPID_SpeechMemoryStream', 'DISPID_SVEBookmark',
    'eLEXTYPE_PRIVATE7', 'SpeechAddRemoveWord',
    'Speech_Max_Pron_Length', 'DISPID_SASCurrentSeekPosition',
    'SSFMCreate', 'DISPID_SFSOpen', 'DISPID_SpeechVoiceEvent',
    'SAFTADPCM_22kHzStereo', 'SAFTCCITT_uLaw_11kHzStereo',
    'SpeechDataKeyLocation', 'DISPID_SGRsCommitAndSave',
    'SVEBookmark', 'DISPID_SOTRemoveStorageFileName',
    'SPDKL_LocalMachine', 'DISPID_SRRRecoContext',
    'DISPID_SRSetPropertyNumber', 'DISPID_SPIRetainedSizeBytes',
    'ISpeechRecoResultTimes', 'SPEI_RECO_OTHER_CONTEXT',
    'SAFT16kHz16BitMono', 'eLEXTYPE_VENDORLEXICON',
    'ISpGrammarBuilder', 'DISPID_SAFGuid', 'DISPID_SABIEventBias',
    'SVP_7', 'DISPID_SRCERecognition', 'ISpeechPhraseAlternate',
    'ISpeechPhraseInfo', 'SPWORDTYPE', 'SpeechAudioProperties',
    'SPAUDIOBUFFERINFO', 'DISPID_SDKGetBinaryValue', 'SITooQuiet',
    'SPEI_TTS_BOOKMARK', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'SAFTNonStandardFormat', 'SAFTCCITT_ALaw_22kHzMono',
    'ISpObjectTokenCategory', 'SpeechStreamSeekPositionType',
    'DISPID_SVEVoiceChange', 'SPCATEGORYTYPE',
    'Speech_Max_Word_Length', 'SPGRAMMARSTATE',
    'DISPID_SAFSetWaveFormatEx', 'SpPhoneConverter', 'SRTStandard',
    'eWORDTYPE_DELETED', 'DISPID_SpeechLexiconWords',
    'DISPID_SDKDeleteKey', 'DISPID_SDKSetLongValue', 'SFTInput',
    'SP_VISEME_11', 'DISPID_SGRSTs_NewEnum', 'SAFT11kHz8BitStereo',
    'SPAS_CLOSED', 'SPEI_MAX_SR', 'DISPID_SRCEPropertyStringChange',
    'SAFTCCITT_ALaw_8kHzStereo', 'DISPID_SLPType',
    'DISPID_SRCEAdaptation', 'DISPID_SVSVisemeId',
    'SREPropertyNumChange', 'SAFT32kHz8BitMono', 'SPPS_Noun',
    'DISPID_SASFreeBufferSpace', 'SPBO_PAUSE', 'SPPS_NotOverriden',
    'SPAR_Medium', 'IEnumSpObjectTokens',
    'DISPID_SpeechPhraseProperties', 'SDTPronunciation',
    'SAFT8kHz8BitStereo', 'DISPID_SGRsCount', 'ISpRecoGrammar2',
    'DISPID_SRRTStreamTime', 'SGRSTTDictation',
    'DISPID_SPRNumberOfElements', 'DISPID_SOTCSetId',
    'SPDATAKEYLOCATION', 'SVP_5', 'DISPID_SDKDeleteValue',
    'DISPID_SGRName', 'SRTEmulated', 'ISpeechCustomStream',
    'SVEEndInputStream', 'DISPID_SOTCId', 'DISPID_SPACommit',
    'ISpNotifySink', 'SAFTCCITT_uLaw_11kHzMono',
    'DISPID_SpeechObjectTokenCategory', 'DISPID_SPILanguageId',
    'DISPID_SOTCEnumerateTokens', 'SP_VISEME_12',
    'eLEXTYPE_RESERVED4', 'SPGS_EXCLUSIVE', 'SpFileStream',
    'ISpRecognizer3', 'SAFT16kHz16BitStereo', 'SPAUDIOOPTIONS',
    'SpeechBookmarkOptions', 'SGLexicalNoSpecialChars',
    'eLEXTYPE_PRIVATE6', 'ISpNotifyTranslator',
    'DISPID_SPEAudioTimeOffset', 'eLEXTYPE_RESERVED10',
    'DISPID_SPRuleNumberOfElements', 'SVSFUnusedFlags',
    'DISPID_SGRs_NewEnum', 'SAFTCCITT_ALaw_11kHzStereo',
    'SpeechEmulationCompareFlags', 'SP_VISEME_7', 'SGSDisabled',
    'DISPID_SRCERecognitionForOtherContext', 'SASClosed',
    'SDTDisplayText', 'SPSNotOverriden', 'DISPID_SGRSTWeight',
    'SRERecognition', 'SVEWordBoundary',
    'SpeechCategoryPhoneConverters', 'DISPID_SMSADeviceId',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'DISPID_SpeechFileStream',
    'DISPID_SMSGetData', 'SP_VISEME_17', 'SpeechInterference',
    'DISPID_SpeechPhraseAlternates', 'DISPID_SpeechRecognizer',
    'SRESoundEnd', 'SREAudioLevel', 'SREAllEvents', 'STSF_FlagCreate',
    'DISPID_SASNonBlockingIO', 'DISPID_SWFEChannels',
    'DISPID_SpeechXMLRecoResult', 'ISpPhoneConverter',
    'SpeechVoiceCategoryTTSRate', 'SDKLCurrentConfig',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SPPHRASEREPLACEMENT',
    'SAFT24kHz8BitMono', 'DISPID_SDKOpenKey',
    'DISPID_SpeechGrammarRule', 'SPEI_TTS_AUDIO_LEVEL',
    'SpInProcRecoContext', 'ISpeechPhraseProperty', 'SRTReSent',
    'DISPID_SPEAudioSizeBytes', 'DISPID_SPRsItem',
    'SECNormalConfidence', 'SpeechGrammarTagDictation',
    'DISPID_SGRId', 'SP_VISEME_16', 'SPTEXTSELECTIONINFO',
    'SRTExtendableParse', 'ISpRecognizer', 'DISPID_SDKEnumValues',
    'SP_VISEME_10', 'ISpeechLexiconWords', 'SPBINARYGRAMMAR',
    'DISPID_SRState', 'DISPID_SRRAudio', 'DISPID_SPRuleName',
    'SPEI_SENTENCE_BOUNDARY', 'ISpeechObjectTokenCategory',
    'SpeechRecognizerState', 'DISPID_SpeechGrammarRuleState',
    'DISPID_SAEventHandle', 'SITooSlow', 'SPWORD',
    'SpUnCompressedLexicon', 'DISPID_SpeechAudioFormat',
    'SpeechPropertyComplexResponseSpeed', 'tagSPTEXTSELECTIONINFO',
    'DISPID_SGRSTPropertyName', 'SSFMCreateForWrite',
    'ISpeechMMSysAudio', 'SPRULE', 'DISPID_SMSSetData', 'SGDisplay',
    'SRSEDone', 'DISPID_SLWsItem', 'ISpEventSource',
    '_RemotableHandle', 'SPGRAMMARWORDTYPE', 'DISPID_SPRText',
    'ISpeechLexiconWord', 'SECFDefault', 'SPEVENT',
    'Speech_StreamPos_RealTime', 'SpeechRegistryUserRoot',
    'SPEI_PROPERTY_NUM_CHANGE', 'SWTAdded', 'DISPID_SRCESoundStart',
    'DISPID_SGRSAddWordTransition', 'DISPID_SPIAudioStreamPosition',
    'SP_VISEME_19', 'SINone', 'SPAR_High', 'DISPID_SPEPronunciation',
    'DISPID_SGRsFindRule', 'SLTApp', 'SPEVENTSOURCEINFO',
    'ISpeechRecoContext', 'SRAExport', 'DISPID_SRAudioInputStream',
    'DISPID_SGRAddState', 'SVP_14', 'DISPID_SVSpeakStream',
    'DISPID_SpeechPhraseRules', 'SGRSTTRule', 'SPWF_SRENGINE',
    'DISPID_SGRInitialState', 'IInternetSecurityMgrSite',
    'SPFM_NUM_MODES', 'DISPID_SPRulesItem', 'ISpNotifySource',
    'SpLexicon', 'DISPID_SGRsCommit',
    'DISPID_SASCurrentDevicePosition', 'SPSMF_SRGS_SAPIPROPERTIES',
    'SPPS_RESERVED3', 'DISPID_SLWType', 'SAFTGSM610_44kHzMono',
    'LONG_PTR', 'SPPS_Modifier', 'SpResourceManager',
    'ISpeechFileStream', 'SAFTNoAssignedFormat',
    'DISPID_SLPPartOfSpeech', 'DISPID_SPCIdToPhone',
    'DISPID_SASetState', 'SP_VISEME_8', 'SAFT22kHz8BitMono',
    'DISPIDSPTSI_ActiveOffset', 'DISPID_SpeechWaveFormatEx',
    'SPEI_RECOGNITION', 'eLEXTYPE_RESERVED8', 'SAFTGSM610_11kHzMono',
    'SWPKnownWordPronounceable', 'SPRS_ACTIVE_USER_DELIMITED',
    'SAFT44kHz8BitStereo', 'SpVoice', 'SpCustomStream',
    'DISPID_SLWLangId', 'SPRECOCONTEXTSTATUS', 'SpeechGrammarState',
    'eLEXTYPE_RESERVED9', 'ISpeechAudio',
    'DISPID_SPEDisplayAttributes',
    'DISPID_SRCAudioInInterferenceStatus', 'DISPID_SRSAudioStatus',
    'SREStreamStart', 'SVP_13', 'SGRSTTEpsilon',
    'DISPID_SRCEInterference', 'DISPID_SOTCreateInstance',
    'SPEI_RECO_STATE_CHANGE', 'SAFT8kHz8BitMono', 'STCInprocServer',
    'DISPID_SVEAudioLevel', 'SGRSTTTextBuffer', 'SPPS_Unknown',
    'DISPID_SMSALineId', 'ISpShortcut', 'DISPID_SOTDataKey',
    'DISPID_SVSInputSentencePosition', 'ISpStreamFormat',
    'DISPID_SRRPhraseInfo', 'SpeechEngineConfidence',
    'DISPID_SPPNumberOfElements',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SPBO_TIME_UNITS', 'SPRST_INACTIVE_WITH_PURGE',
    'DISPID_SVSLastBookmark', 'SGPronounciation',
    'DISPID_SRGCmdLoadFromResource', 'DISPID_SRSCurrentStreamNumber',
    'SVPNormal', 'SpeechGrammarTagWildcard', 'eLEXTYPE_PRIVATE9',
    'SpeechGrammarRuleStateTransitionType', 'SpeechUserTraining',
    'SPEI_FALSE_RECOGNITION', 'DISPID_SPARecoResult',
    'DISPID_SBSSeek', 'DISPID_SpeechPhraseProperty', 'SPVOICESTATUS',
    'SPSEMANTICFORMAT', 'DISPID_SRSCurrentStreamPosition',
    'SpeechTokenIdUserLexicon', 'DISPID_SLAddPronunciationByPhoneIds',
    'SPWORDLIST', 'ISpeechRecoGrammar', 'UINT_PTR',
    'SpeechDiscardType', 'DISPID_SLPsCount', 'DISPID_SPPsItem',
    'DISPID_SGRSRule', 'SECFNoSpecialChars', 'SDTAll',
    '_SPAUDIOSTATE', 'ISpEventSink', 'SP_VISEME_13',
    'DISPID_SPIProperties', 'SPRS_INACTIVE', 'DISPID_SRCResume',
    'SpeechRetainedAudioOptions', 'DISPID_SABufferNotifySize',
    'SSTTTextBuffer', 'SAFT8kHz16BitMono', 'SAFTADPCM_44kHzStereo',
    'STSF_LocalAppData', 'DISPID_SpeechAudioStatus',
    'DISPID_SPRuleFirstElement', 'SpWaveFormatEx',
    'SpeechRecognitionType', 'SDTProperty', 'SpeechCategoryAudioOut',
    'DISPID_SGRsAdd', 'DISPID_SGRsItem', 'ISpeechPhoneConverter',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SPEI_START_INPUT_STREAM',
    'SREStreamEnd', 'SPRST_ACTIVE_ALWAYS', 'SPWT_DISPLAY',
    'DISPID_SRGIsPronounceable', 'SPCT_SLEEP',
    'DISPID_SRGetRecognizers', 'DISPID_SADefaultFormat',
    'SFTSREngine', 'ISpStreamFormatConverter', 'DISPID_SPEsItem',
    'SVP_3', 'SpeechPropertyLowConfidenceThreshold',
    'DISPID_SPRulesCount', 'SAFT24kHz16BitStereo',
    'ISpeechResourceLoader', 'SPINTERFERENCE_TOOQUIET',
    'SPLO_DYNAMIC', 'DISPID_SPIEngineId', 'SPDKL_CurrentConfig',
    'DISPID_SRGCmdLoadFromMemory', 'SPEVENTENUM',
    'DISPID_SRCEAudioLevel', 'DISPID_SPIGrammarId', 'SSTTDictation',
    'DISPID_SpeechPhraseReplacements', 'DISPID_SRGRules', 'SVP_16',
    'WAVEFORMATEX', 'SpeechTokenKeyUI', 'SAFT48kHz8BitStereo',
    'SVSFNLPMask', 'DISPID_SRCRetainedAudio',
    'DISPID_SRGSetTextSelection', 'SPINTERFERENCE_TOOLOUD',
    'DISPID_SOTGetAttribute', 'DISPID_SpeechRecoContextEvents',
    'DISPID_SWFEAvgBytesPerSec', 'DISPID_SpeechVoice',
    'DISPID_SRProfile', 'SVEVoiceChange', 'DISPID_SRRAudioFormat',
    'SVEAllEvents', 'SGRSTTWord', 'SPRST_ACTIVE',
    'DISPID_SpeechLexiconWord', 'SpeechAudioFormatGUIDWave',
    'DISPID_SBSFormat', 'DISPID_SLRemovePronunciationByPhoneIds',
    'SVSFIsXML', 'DISPID_SBSRead', 'STCInprocHandler',
    'DISPID_SPIGetDisplayAttributes', 'DISPID_SpeechPhraseBuilder',
    'DISPID_SWFEBlockAlign', 'SAFT22kHz16BitStereo',
    'DISPID_SDKGetStringValue', 'SpPhoneticAlphabetConverter',
    'SpeechTokenContext', 'SPCS_ENABLED', 'Speech_StreamPos_Asap',
    'SDTRule', 'DISPID_SOTs_NewEnum', 'DISPID_SRCRequestedUIType',
    'ISpPhoneticAlphabetConverter', 'ISpeechPhraseElement',
    'SpPhraseInfoBuilder', 'SVESentenceBoundary',
    'SAFTGSM610_22kHzMono', 'DISPID_SGRAddResource',
    'DISPID_SBSWrite', 'ISpeechTextSelectionInformation',
    'SPWORDPRONOUNCEABLE', 'DISPID_SVSyncronousSpeakTimeout',
    '_ISpeechVoiceEvents', 'SVSFDefault', 'DISPID_SpeechPhraseRule',
    'DISPID_SVEEnginePrivate', 'DISPID_SRSetPropertyString',
    'SAFTCCITT_ALaw_44kHzMono', 'SPEI_RESERVED1', 'SPCT_DICTATION',
    'SREPhraseStart', 'SREInterference', 'DISPID_SVGetAudioInputs',
    'DISPID_SPRs_NewEnum', 'DISPID_SVIsUISupported', 'SGDSActive',
    'ISpeechPhraseProperties', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'DISPID_SpeechPhraseInfo', 'DISPID_SGRSTNextState', 'SPAS_PAUSE',
    'SPPARTOFSPEECH', 'SRAONone', 'SECFEmulateResult',
    'SpeechAudioFormatGUIDText', 'SpeechTokenShellFolder', 'SPAS_RUN',
    'DISPID_SRCCmdMaxAlternates', 'SLTUser', 'SDTLexicalForm',
    'SPPS_LMA', 'SDTAudio', 'DISPID_SGRSTPropertyId',
    'SREPropertyStringChange', 'ISpProperties',
    'DISPID_SPISaveToMemory', 'DISPID_SRRecognizer',
    'SpeechRegistryLocalMachineRoot', 'DISPID_SRAudioInput',
    'SREHypothesis', 'ISpeechObjectTokens', 'SPWF_INPUT',
    'ISpeechAudioBufferInfo', 'ISpXMLRecoResult', 'SVSFParseMask',
    'SVP_8', 'DISPID_SVRate', 'ISpObjectToken', 'SVSFVoiceMask',
    'SPINTERFERENCE_LATENCY_WARNING', 'ISpeechPhraseRules',
    'SAFT22kHz8BitStereo', 'DISPID_SpeechLexiconPronunciation',
    'SpNotifyTranslator', 'DISPID_SLPs_NewEnum', 'SPFM_CREATE',
    'ISpeechPhraseReplacements', 'SPVISEMES',
    'DISPID_SRRTOffsetFromStart', 'SVP_18', 'SPEI_MAX_TTS',
    'SPSHT_OTHER', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'DISPID_SRGCmdSetRuleIdState', 'SVP_4', 'SECLowConfidence',
    'SPFM_CREATE_ALWAYS', 'DISPID_SPEAudioStreamOffset', 'SPSUnknown',
    'eLEXTYPE_PRIVATE14', 'ISpRecoContext2', 'SITooLoud',
    'SVSFParseAutodetect', 'DISPID_SRSSupportedLanguages',
    'DISPID_SVSCurrentStreamNumber', 'SpeechGrammarWordType',
    'SGSExclusive', 'SPFILEMODE', 'DISPIDSPRG', 'SPEI_END_SR_STREAM',
    'DISPID_SRGDictationUnload', 'eLEXTYPE_PRIVATE8', 'SPAR_Low',
    'SpeechVisemeType', 'DISPID_SVSpeak', 'SRESoundStart',
    'DISPID_SOTSetId', 'DISPID_SOTRemove', 'SP_VISEME_5',
    'SPEI_END_INPUT_STREAM', 'SpeechRuleState',
    'DISPID_SVSLastBookmarkId', 'DISPID_SLWWord', 'SVP_6',
    'SECFIgnoreKanaType', 'SPSHORTCUTTYPE', 'DISPID_SWFEFormatTag',
    'DISPID_SLRemovePronunciation', 'SPXRO_Alternates_SML',
    'tagSPPROPERTYINFO', 'SREStateChange', 'DISPID_SGRSTsItem',
    'SPFM_OPEN_READONLY', 'SPSInterjection',
    'DISPID_SPIAudioSizeTime', 'SPEI_WORD_BOUNDARY', 'SPRS_ACTIVE',
    'SRAInterpreter', 'SVSFParseSapi', 'DISPID_SOTMatchesAttributes',
    'SpeechAudioFormatType', 'SLOStatic', 'DISPID_SGRSTransitions',
    'DISPID_SGRClear', 'DISPID_SRCERecognizerStateChange',
    'DISPID_SAVolume', 'SSFMOpenReadWrite', 'SpeechTokenKeyFiles',
    'DISPID_SRGCmdLoadFromFile', 'STSF_AppData', 'SVP_10',
    'DISPID_SVEViseme', 'DISPID_SPELexicalForm', 'SAFT11kHz8BitMono',
    'DISPID_SASState', 'DISPID_SVSInputSentenceLength',
    'SpeechCategoryRecoProfiles', 'DISPID_SVAudioOutput',
    'DISPID_SPAsItem', 'SPSEMANTICERRORINFO',
    'SAFTCCITT_ALaw_22kHzStereo', 'SpStream',
    'DISPID_SDKSetBinaryValue', 'ISpResourceManager',
    'SAFT48kHz8BitMono', 'DISPID_SRRSpeakAudio', 'DISPID_SLGetWords',
    'SVF_Stressed', 'DISPID_SpeechRecoResult2', 'SPSHT_Unknown',
    'DISPID_SOTDisplayUI', 'DISPID_SRRDiscardResultInfo',
    'DISPID_SRGRecoContext', 'SRERecoOtherContext',
    'DISPID_SRRSaveToMemory', 'SPBOOKMARKOPTIONS',
    'eLEXTYPE_RESERVED7', 'SAFTTrueSpeech_8kHz1BitMono',
    'SPWAVEFORMATTYPE', 'DISPID_SVSRunningState', 'DISPID_SRGCommit',
    'SpTextSelectionInformation', 'SPSFunction', 'DISPID_SAStatus',
    'SVP_15', 'SRCS_Disabled', 'SPPS_Function', 'ISpStream',
    'DISPID_SRSNumberOfActiveRules', 'eLEXTYPE_PRIVATE10',
    'ISpeechVoiceStatus', 'SPSNoun', 'DISPID_SPPs_NewEnum',
    'STSF_CommonAppData', 'SDA_Consume_Leading_Spaces',
    'SAFT8kHz16BitStereo', 'SWTDeleted', 'DISPID_SpeechMMSysAudio',
    'SPPROPERTYINFO', 'SGDSInactive', 'SVSFParseSsml',
    'DISPID_SPRsCount', 'DISPID_SpeechVoiceStatus',
    'DISPID_SPIGetText', 'DISPID_SRGState', 'ISpeechAudioFormat',
    'ISpeechPhraseElements', 'SPSSuppressWord', 'ISpeechDataKey',
    'SPSMF_UPS', 'SAFT22kHz16BitMono', 'SSSPTRelativeToEnd',
    'SPRST_NUM_STATES', 'DISPID_SDKCreateKey', 'SPEI_MIN_SR',
    'DISPID_SRCEHypothesis', 'SPCT_SUB_COMMAND', 'ISpeechBaseStream',
    'SRTSMLTimeout', 'SPEI_RESERVED6', 'SpeechEngineProperties',
    'DISPID_SRCVoicePurgeEvent', 'SpeechTokenValueCLSID',
    'DISPID_SPCPhoneToId', 'SVSFIsNotXML',
    'DISPID_SVSpeakCompleteEvent', 'DISPID_SRCEPropertyNumberChange',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'ISpeechAudioStatus', 'SRSActive', 'SVEAudioLevel',
    'SPSHT_NotOverriden', 'SPINTERFERENCE_TOOSLOW', 'DISPID_SVResume',
    'SAFTCCITT_uLaw_22kHzStereo', 'STCAll', 'SDA_No_Trailing_Space',
    'DISPID_SPRuleParent', 'SP_VISEME_9', 'IStream',
    'DISPID_SRCSetAdaptationData', 'DISPID_SRCEFalseRecognition',
    'SBOPause', 'SP_VISEME_4', 'ISpeechGrammarRule',
    'SRSActiveAlways', 'eLEXTYPE_PRIVATE16', 'DISPID_SVPause',
    'SVSFNLPSpeakPunc', 'DISPID_SPPName', 'SP_VISEME_2',
    'ISpeechVoice', 'SPEI_REQUEST_UI', 'SpeechRunState',
    'SPINTERFERENCE_NOSIGNAL', 'DISPID_SRGetPropertyString', 'SVP_19',
    'SAFT32kHz8BitStereo', 'SpAudioFormat', 'SPEI_PHRASE_START',
    'eLEXTYPE_PRIVATE1', 'ISpeechRecognizer', 'SRADefaultToActive',
    'ISpeechRecoResult', 'SPRULESTATE', 'SPPS_Interjection',
    'DISPID_SLPLangId', 'DISPID_SVAudioOutputStream',
    'SPEI_HYPOTHESIS', 'SPSModifier', 'DISPID_SLAddPronunciation',
    'SpeechPropertyResourceUsage', 'DISPID_SGRSTText',
    'DISPID_SpeechRecoResultTimes', 'DISPID_SPEs_NewEnum',
    'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SPIAudioSizeBytes', 'SPPS_Noncontent',
    'DISPID_SPIReplacements', 'SpShortcut', 'SPSHORTCUTPAIR',
    'DISPID_SPIRule', 'DISPIDSPTSI_SelectionLength',
    'DISPID_SRSClsidEngine', 'DISPID_SGRSAddRuleTransition',
    'DISPID_SGRSTPropertyValue', 'SVEPhoneme', 'DISPID_SRGReset',
    'SAFT11kHz16BitMono', 'DISPID_SRRSetTextFeedback',
    'SPEI_RESERVED5', 'SpeechRecoEvents', 'eLEXTYPE_MORPHOLOGY',
    'DISPID_SPAStartElementInResult', 'SVSFIsFilename', 'SPLO_STATIC',
    'SAFT16kHz8BitMono', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'SECHighConfidence', 'DISPID_SPERetainedStreamOffset',
    'SpeechRuleAttributes', 'SpeechWordType', 'eLEXTYPE_PRIVATE15',
    'SpeechDisplayAttributes', 'SPINTERFERENCE_NOISE',
    'SpObjectToken', 'DISPID_SPIStartTime',
    'DISPID_SpeechPhraseAlternate', 'DISPID_SLWsCount',
    'ISpeechLexicon', 'SPBO_NONE', 'eLEXTYPE_PRIVATE4',
    'SRSInactiveWithPurge', 'DISPID_SABufferInfo',
    'DISPID_SPPConfidence', 'ISpDataKey',
    'DISPID_SpeechPhraseElement', 'SpeechVoiceSpeakFlags',
    'SpeechRecoContextState', 'DISPID_SVGetAudioOutputs',
    'SPWT_PRONUNCIATION', 'SGRSTTWildcard', 'SPVPRI_OVER',
    'DISPID_SGRSTType', 'DISPID_SRGCmdLoadFromObject',
    'DISPID_SRCreateRecoContext', 'DISPID_SPEEngineConfidence',
    'SRCS_Enabled', 'ISpLexicon', 'DISPID_SRCERequestUI',
    'SWPUnknownWordUnpronounceable', 'DISPID_SVVolume',
    'SAFTADPCM_11kHzStereo', 'SpeechLexiconType', 'SRSInactive',
    'SRAORetainAudio', 'DISPID_SMSAMMHandle', 'Speech_Default_Weight',
    'SAFT44kHz8BitMono'
]

_check_version('1.2.0', 1698381255.477747)
